...
const UnscoredPositionPicksScreen = () => {
    ...
    const navigateToPosition = (newPosition: number) => {
        router.push(`/unscored-position-picks?leagueId=${leagueId}&weekNumber=${weekNumber}&position=${newPosition}&leagueName=${leagueName}` as any);
    };
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.loadingContainer}>
                    ...
                    <Text style={styles.loadingText}>Loading position picks...</Text>
                </View>
            </SafeAreaView>
        );
    }
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.errorContainer}>
                    ...
                    <Text style={styles.errorMessage}>{error || 'Position picks not found'}</Text>
            ...
            <ResponsiveContainer>
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>Position Picks</Text>
                                ...
                                <View style={styles.section}>
                                    ...
                                    <View style={styles.overviewStats}>
                                        ...
                                        <View style={styles.statItem}>
                                            ...
                                            <Text style={styles.statValue}>{results.picks.length}</Text>
                                        </View>
                                        <View style={styles.statItem}>
                                            <Text style={styles.statLabel}>Completion</Text>
                                            <Text style={styles.statValue}>
                                                {Math.round((results.picks.length / results.totalParticipants) * 100)}%
                                            </Text>
                                        </View>
                                    </View>
                                </View>
                                ...
                                <View style={styles.section}>
                                    ...
                                    <View style={styles.statusCard}>
                                        ...
                                        <View style={styles.statusInfo}>
                                            <Text style={styles.statusTitle}>Race Not Scored</Text>
                                            ...
                                            >
                                                <View style={styles.pickHeader}>
                                                    ...
                                                    <View style={styles.pickStatus}>
                                                        <Text style={styles.statusText}>Not Scored</Text>
                                                        <Text style={styles.statusSubtext}>Race pending</Text>
                                                    </View>
                                                </View>
                                            </TouchableOpacity>
                                        ))}
